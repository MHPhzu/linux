...
server.on('request', function(req, res) {
    ...
    if (currentUrl == '/') {
        fs.readFile('../static/templates/liuyan.html', 'utf8', function(err, data) {
        ...
        fs.readFile('../static/templates/add.html', 'utf8', function(err, data) {
            if (err) res.end('404 Not Found');
            res.setHeader('Content-Type', 'text/html;charset=utf-8');
            res.write(data)
            res.end()
        ...
        //否则404
        fs.readFile('../static/templates/404.html', 'utf8', function(err, data) {
            if (err) res.end('404 Not Found');
            res.setHeader('Content-Type', 'text/html;charset=utf-8');
            res.write(data)
            res.end()
